...
public class ShaderHelper {
    ...
    private static int compileShader(int type, String shaderCode) {
        ...
        if (true) {
            // Print the shader info LogUtils to the Android LogUtils output.
    ...
    public static int linkProgram(int vertexShaderId, int fragmentShaderId) {
        ...
        if (true) {
            // Print the program info LogUtils to the Android LogUtils output.
    ...
    public static boolean validateProgram(int programObjectId) {
        ...
        LogUtils.v(TAG, "Results of validating program: " + validateStatus[0]
                + "\nLogUtils:" + glGetProgramInfoLog(programObjectId));
